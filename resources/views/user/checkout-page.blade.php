...
<div class="row">
  <div class="col-md-6 mb-3">
	...
	<input type="text" class="form-control" id="firstName" placeholder="Họ và tên đệm" value="{{ Session::get('user')->FirstName }}" required="">
  ...
  <div class="col-md-6 mb-3">
	...
	<input type="text" class="form-control" id="lastName" placeholder="Tên" value="{{ Session::get('user')->LastName }}" required="">
	<div class="invalid-feedback">
...
<div class="mb-3">
  ...
  <div class="input-group">
	...
	<input type="text" class="form-control" id="username" placeholder="Tên tài khoản" value="{{ Session::get('user')->UserName }}" required=""> 
...
<div class="mb-3">
  ...
  <input type="email" class="form-control" id="email" value="{{ Session::get('user')->email }}" disabled>
  <div class="invalid-feedback">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="address" placeholder="Nhập địa chỉ nhận đơn" required="" value="{{ $shippingAddress }}">
  @else
  <input type="text" class="form-control" id="address" placeholder="Nhập địa chỉ nhận đơn" required="">
  @endif
  <div class="invalid-feedback">
