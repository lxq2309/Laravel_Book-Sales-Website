		...
		<div class="col-xs-12 col-sm-10 col-md-9 d-flex float-left align-items-center compare-right">
			...
			<div class="row">
				<div class="single-item col-sm-4 col-xs-4">
					...
					<div class="image"><img src="/user/assets/img/products/01.jpg" class="img-fluid" alt=""></div>
				</div>
				<div class="single-item col-sm-4 col-xs-4">
					<div class="remove"></div>
					<div class="image"><img src="/user/assets/img/products/02.jpg" class="img-fluid" alt=""></div>
				</div>
				<div class="single-item col-sm-4 col-xs-4">
					<div class="remove"></div>
					<div class="image"><img src="/user/assets/img/products/03.jpg" class="img-fluid" alt=""></div>
				</div>
			</div>
			</div>
