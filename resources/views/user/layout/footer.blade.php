        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                        <input type="text" id="RegisterForm-name" class="form-control validate" placeholder="Tên"
                    ...
                    if (response.error) {
                        ...
                        if (response.message === 'Email does not exist') {
                            ...
                            $('#LoginForm-email').after(
                                '<div class="text-danger">Email không tồn tại</div>');
                        } else if (response.message === 'Invalid password') {
                            $('#LoginForm-email + .text-danger').remove();
                            $('#LoginForm-pass + .text-danger').remove();
                            $('#LoginForm-pass').after(
                                '<div class="text-danger">Mật khẩu sai, kiểm tra lại</div>'
                                );
                        } else {
