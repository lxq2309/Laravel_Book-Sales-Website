                      ...
                      <div class="product-large-image tab-content">
                          <div class="tab-pane active" id="product-01" role="tabpanel" aria-labelledby="product-tab-01">
                              <div class="single-img img-full">
                                  <a href="/user/assets/img/products/01.jpg"><img src="/user/assets/img/products/01.jpg" class="img-fluid zoomImg" alt=""></a>
                              </div>
                          </div>
                          <div class="tab-pane" id="product-02" role="tabpanel" aria-labelledby="product-tab-02">
                              <div class="single-img">
                                  <a href="/user/assets/img/products/02.jpg"><img src="/user/assets/img/products/02.jpg" class="img-fluid" alt=""></a>
                              </div>
                          </div>
                          <div class="tab-pane" id="product-03" role="tabpanel" aria-labelledby="product-tab-03">
                              <div class="single-img">
                                  <a href="/user/assets/img/products/03.jpg"><img src="/user/assets/img/products/03.jpg" class="img-fluid" alt=""></a>
                              </div>
                          </div>
                          <div class="tab-pane" id="product-04" role="tabpanel" aria-labelledby="product-tab-04">
                              <div class="single-img">
                                  <a href="/user/assets/img/products/04.jpg"><img src="/user/assets/img/products/04.jpg" class="img-fluid" alt=""></a>
                              </div>
                          </div>
                          <div class="tab-pane" id="product-05" role="tabpanel" aria-labelledby="product-tab-05">
                              <div class="single-img">
                                  <a href="/user/assets/img/products/05.jpg"><img src="/user/assets/img/products/05.jpg" class="img-fluid" alt=""></a>
                              </div>
                          </div>
                                  ...
                                  <div class="nav-add small-image-slider-single-product-tabstyle-3 owl-carousel" role="tablist">
                                      <div class="single-small-image img-full">
                                          <a data-toggle="tab" id="product-tab-01" href="#product-01" class="img active"><img src="/user/assets/img/products/01.jpg" class="img-fluid" alt=""></a>
                                      </div>
                                      <div class="single-small-image img-full">
                                          <a data-toggle="tab" id="product-tab-02" href="#product-02" class="img"><img src="/user/assets/img/products/02.jpg" class="img-fluid" alt=""></a>
                                      </div>
                                      <div class="single-small-image img-full">
                                          <a data-toggle="tab" id="product-tab-03" href="#product-03" class="img"><img src="/user/assets/img/products/03.jpg" class="img-fluid" alt=""></a>
                                      </div>
                                      <div class="single-small-image img-full">
                                          <a data-toggle="tab" id="product-tab-04" href="#product-04" class="img"><img src="/user/assets/img/products/04.jpg" class="img-fluid" alt=""></a>
                                      </div>
                                      <div class="single-small-image img-full">
                                          <a data-toggle="tab" id="product-tab-05" href="#product-05" class="img"><img src="/user/assets/img/products/05.jpg" class="img-fluid" alt=""></a>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="row">
                                  ...
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              ...
                                              <img src="/user/assets/img/products/02.jpg" alt="02" class="second_image img-responsive"/>										</a>									</div>
                                  ...
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              ...
                                              <img src="/user/assets/img/products/03.jpg" alt="03" class="second_image img-responsive"/>									</a>									</div>
                                      <div class="thumb-description">
                                          <div class="caption">
                                  ...
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              ...
                                              <img src="/user/assets/img/products/04.jpg" alt="04" class="second_image img-responsive"/>
                                                                                  </a>
                                                                                              </div>
                                      <div class="thumb-description">
                                          <div class="caption">
                                  ...
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              ...
                                              <img src="/user/assets/img/products/05.jpg" alt="05" class="second_image img-responsive"/>										</a>									</div>
                                      <div class="thumb-description">
                                          <div class="caption">
                                  ...
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              ...
                                              <img src="/user/assets/img/products/06.jpg" alt="06" class="second_image img-responsive"/>										</a>									</div>
                                      <div class="thumb-description">
                                          <div class="caption">
                              ...
                              <div class="product-layouts">
                                  <div class="product-thumb">
                                      <div class="image zoom">
                                          <a href="product-details.html">
                                              <img src="/user/assets/img/products/06.jpg" alt="06"/>
                                                  <img src="/user/assets/img/products/07.jpg" alt="07" class="second_image img-responsive"/>												</a>									</div>
                                      <div class="thumb-description">
                                          <div class="caption">
