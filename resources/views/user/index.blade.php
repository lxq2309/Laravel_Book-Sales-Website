                                        ...
                                        <div class="thumb-description">
                                            <div class="caption">
                                                <h4 class="product-title text-capitalize"><a
                                                        href="{{ route('product-detail', $book->BookID) }}">{{ $book->BookTitle }}</a></h4>
                                            </div>
                                            <div class="rating">
                                            ...
                                            <div class="button-wrapper">
                                                <div class="button-group text-center">
                                                    <button type="button" class="btn btn-primary btn-cart"
                                                        ...
                                                        data-book-name="{{ $book->BookTitle }}" data-book-price="{{ $book->SellingPrice }}"
                                                        ><i
...
@section('scripts')
    ...
    $(document).ready(function () {
        $('.btn-quickview').on('click', function () {
            var bookName = $(this).data('book-name');
            var bookPrice = $(this).data('book-price');
            var bookDes = $(this).data('book-des');
            $('#product_view .product-title').text(bookName);
            $('#product_view .regular-price').text(bookPrice);
            $('#product_view .description').text(bookName);
        });
    });
    </script>
@endsection
